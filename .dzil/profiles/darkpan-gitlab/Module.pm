...
L<{{ $name }}> uses well-tested and widely-used DarkPAN modules, so installation should be as simple as

    $ cpanm --mirror=https://darkpan.keedi.kim --mirror=http://cpan.keedi.kim --mirror-only {{ $name }}
